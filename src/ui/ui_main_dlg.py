...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnSignMessageForCurrMn = QtWidgets.QPushButton(self.gbMain)
        self.btnSignMessageForCurrMn.setObjectName("btnSignMessageForCurrMn")
        self.layMasternodesControl.addWidget(self.btnSignMessageForCurrMn)
        ...
        self.toolBar.setIconSize(QtCore.QSize(56, 24))
        ...
        self.action_see_all_masternodes = QtWidgets.QAction(MainWindow)
        self.action_see_all_masternodes.setObjectName("action_see_all_masternodes")
        self.action_hw_configuration = QtWidgets.QAction(MainWindow)
        self.action_hw_configuration.setVisible(False)
        ...
        self.action_hw_initialization_recovery.setVisible(False)
        ...
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.action_clear_wallet_cache)
        self.menuTools.addSeparator()
        ...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.action_see_all_masternodes)
        self.toolBar.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnCancelEditingMn.setText(_translate("MainWindow", "Cancel edit"))
        self.btnSignMessageForCurrMn.setToolTip(_translate("MainWindow", "Sign message for the current masternode."))
        self.btnSignMessageForCurrMn.setText(_translate("MainWindow", "Sign"))
        self.lblMasternodeStatus.setText(_translate("MainWindow", "Masternode status"))
        self.btnRefreshMnStatus.setToolTip(_translate("MainWindow", "Retrieve this masternode\'s latest network statistics."))
        self.btnRefreshMnStatus.setText(_translate("MainWindow", "Get status"))
        self.btnBroadcastMn.setToolTip(_translate("MainWindow", "Broadcast a message across the GIN network to start your masternode, from your hardware wallet."))
        self.btnBroadcastMn.setText(_translate("MainWindow", " Start masternode with hardware wallet "))
        ...
        self.action_open_recent_files.setTitle(_translate("MainWindow", "Recent config files"))
        ...
        self.action_transfer_funds_for_any_address.setText(_translate("MainWindow", "Wallet"))
        self.action_transfer_funds_for_any_address.setToolTip(_translate("MainWindow", "Transfer and receive coins."))
        self.action_sign_message_for_cur_mn.setText(_translate("MainWindow", "Sign"))
        self.action_sign_message_for_cur_mn.setIconText(_translate("MainWindow", "Sign"))
        self.action_sign_message_for_cur_mn.setToolTip(_translate("MainWindow", "Sign message for the current masternode."))
        self.action_see_all_masternodes.setText(_translate("MainWindow", "Masternodes"))
        self.action_see_all_masternodes.setIconText(_translate("MainWindow", "Masternodes"))
        self.action_see_all_masternodes.setToolTip(_translate("MainWindow", "See your masternodes, as well as other masternodes on the network."))
        self.action_hw_configuration.setText(_translate("MainWindow", "Hardware wallet PIN/passphrase configuration..."))
        self.action_hw_configuration.setIconText(_translate("MainWindow", "Hardware wallet PIN/passphrase configuration"))
        self.action_load_config_file.setText(_translate("MainWindow", "Open config file..."))
        self.action_load_config_file.setToolTip(_translate("MainWindow", "Open configuration file"))
        self.action_save_config_file_as.setText(_translate("MainWindow", "Save config as..."))
        self.action_save_config_file.setText(_translate("MainWindow", "Save"))
        self.action_save_config_file.setToolTip(_translate("MainWindow", "Save the current configuration."))
        self.action_check_network_connection.setText(_translate("MainWindow", "Connect"))
        self.action_check_network_connection.setToolTip(_translate("MainWindow", "Check connection with GINcoin network."))
        ...
        self.action_test_hw_connection.setText(_translate("MainWindow", "Detect"))
        self.action_test_hw_connection.setToolTip(_translate("MainWindow", "Establish connection with hardware wallet."))
        self.action_disconnect_hw.setText(_translate("MainWindow", "Disconnect"))
        self.action_disconnect_hw.setToolTip(_translate("MainWindow", "Disconnect hardware wallet."))
        ...
        self.action_about_app.setText(_translate("MainWindow", "About GINware..."))
        self.action_about_app.setToolTip(_translate("MainWindow", "About GINware"))
        self.action_import_masternode_conf.setText(_translate("MainWindow", "Import masternodes from a \'masternode.conf\' file..."))
        ...
        self.action_open_data_folder.setText(_translate("MainWindow", "Open GINware data folder"))
        self.action_clear_wallet_cache.setText(_translate("MainWindow", "Clear wallet cache"))
