...
class Ui_WdgMasternodeDetails(object):
    def setupUi(self, WdgMasternodeDetails):
        ...
        WdgMasternodeDetails.resize(741, 384)
        ...
        self.lblName.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblIP.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblPort.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblProtocolVersion.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblCollateral.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblCollateralPath.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblCollateralTxHash.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblCollateralTxIndex.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblDMNTxHash.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblMasternodePrivateKey.setMinimumSize(QtCore.QSize(144, 0))
        self.lblMasternodePrivateKey.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.btnCopyMnKey.setMaximumSize(QtCore.QSize(16777215, 21))
        self.btnCopyMnKey.setText("")
        self.btnCopyMnKey.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        self.btnCopyMnKey.setArrowType(QtCore.Qt.NoArrow)
        self.btnCopyMnKey.setObjectName("btnCopyMnKey")
        self.horizontalLayout.addWidget(self.btnCopyMnKey)
        ...
        self.lblOwnerKey.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblOperatorKey.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        self.lblVotingKey.setCursor(QtGui.QCursor(QtCore.Qt.WhatsThisCursor))
        ...
        WdgMasternodeDetails.setTabOrder(self.edtMasternodePrivateKey, self.edtOwnerKey)
        ...
        WdgMasternodeDetails.setTabOrder(self.edtVotingKey, self.btnGenerateMnPrivateKey)
        WdgMasternodeDetails.setTabOrder(self.btnGenerateMnPrivateKey, self.chbRoleOwner)
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.lblName.setToolTip(_translate("WdgMasternodeDetails", "A custom label for the masternode.\n"
"This is just for you, it is not sent to the network."))
        self.lblName.setText(_translate("WdgMasternodeDetails", "Name"))
        self.lblIP.setToolTip(_translate("WdgMasternodeDetails", "The IP address of the masternode."))
        self.lblIP.setText(_translate("WdgMasternodeDetails", "IP"))
        self.lblPort.setToolTip(_translate("WdgMasternodeDetails", "The peer-to-peer network port of the masternode. Leave at the default value."))
        self.lblPort.setText(_translate("WdgMasternodeDetails", "port"))
        self.lblProtocolVersion.setToolTip(_translate("WdgMasternodeDetails", "The protocol version of the masternode."))
        ...
        self.lblCollateral.setToolTip(_translate("WdgMasternodeDetails", "The address that the collateral was sent to."))
        ...
        self.lblCollateralPath.setToolTip(_translate("WdgMasternodeDetails", "The BIP32 path of your hardware wallet that corresponds to the address which the collateral was sent to."))
        self.lblCollateralPath.setText(_translate("WdgMasternodeDetails", "path"))
        self.btnShowCollateralPathAddress.setToolTip(_translate("WdgMasternodeDetails", "Show GINcoin address for the entered BIP32 path"))
        self.lblCollateralTxHash.setToolTip(_translate("WdgMasternodeDetails", "The hash of the collateral transaction."))
        self.lblCollateralTxHash.setText(_translate("WdgMasternodeDetails", "Collateral TX hash"))
        self.lblCollateralTxIndex.setToolTip(_translate("WdgMasternodeDetails", "The index of the output corresponding to the collateral in the collateral transaction."))
        ...
        self.lblMasternodePrivateKey.setToolTip(_translate("WdgMasternodeDetails", "The private key for the masternode.\n"
"Used for the `masternode start` message and other masternode-related broadcasts."))
        self.lblMasternodePrivateKey.setText(_translate("WdgMasternodeDetails", "Masternode private key"))
        self.btnCopyMnKey.setToolTip(_translate("WdgMasternodeDetails", "Copy key to clipboard"))
