...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.lbl_warning = QtWidgets.QLabel(self.pnl_input)
        self.lbl_warning.setTextFormat(QtCore.Qt.RichText)
        self.lbl_warning.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lbl_warning.setObjectName("lbl_warning")
        self.lay_input.addWidget(self.lbl_warning)
        ...
        self.wdgLeftPanel.setMinimumSize(QtCore.QSize(300, 0))
        ...
        self.dest_widget1.setMinimumSize(QtCore.QSize(0, 150))
    ...
    def retranslateUi(self, WalletDlg):
        ...
        self.lbl_warning.setText(_translate("WalletDlg", "<html><head/><body><p>Before receiving coins with <span style=\" font-weight:600;\">any</span> address, please right-click and choose <span style=\" font-weight:600;\">Check address on device</span>.<br/>Make sure you see the <span style=\" font-weight:600;\">exact</span> same address on your hardware wallet\'s screen!</p></body></html>"))
        ...
        self.chbHideCollateralTx.setText(_translate("WalletDlg", "Hide saved masternodes\' collateral transactions"))
        self.btnSend.setText(_translate("WalletDlg", "Sign Transaction"))
